                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><span class="tag tag-success">{{$posts->title ?? ''}}</span></td>
                         <td>{!! $posts->message ?? '' !!}</td>
                      <td>


         
                    <img src="{{asset($posts->image)}}" class="img-circle elevation-2" style="height:50px;width: 50px;" alt="User Image">
 
                      </td>
                                     <td> <a href="{{route('deletetpost', $posts->id)}}">Delete</a>  </td>
                      @endif
                      @endforeach
                      @endif
                      </tr>
          ...
          <div class="col-lg-10 col-sm-12 col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                  ...
                  <form action="{{route('sendblogpost')}}" method="post" enctype="multipart/form-data">
